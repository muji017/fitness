...
export const getAllAdminVideosListApi = createAction("getAllAdminVideosListApi")
...
export const changeVideoStatusApi = createAction("changeVideoStatusApi", props<{ videoId: any }>())
export const changeVideoPremiumApi =createAction('changeVideoPremiumApi',props<{videoId:any}>())